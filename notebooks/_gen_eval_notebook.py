"""Generate 06_eval_results.ipynb. Run once after editing this file.

Usage (from code/notebooks/):
    python _gen_eval_notebook.py
"""
...
cells.append(code("!pip install -q torch_geometric pandas numpy matplotlib"))
cells.append(code(
...
# 8. Test-time g override comparison
cells.append(md(
...
out_path = "06_eval_results.ipynb"
